...
{
    public class ExportSphinxComponent : GH_Component
    {
        public ExportSphinxComponent()
          : base("Export Sphinx", "ExportSphinx", "Generates a site structure compatible with Sphinx and ReadTheDocs using reStructuredText (.rst) formatting.", "DocsHopper", "Export")
        {
        }
        ...
        {
            pManager.AddTextParameter("Sphinx Folder", "Dir", "Sphinx folder", GH_ParamAccess.item);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            string statusMessage = exporter.ExportSphinxSite(outputDirectory, pluginName, mainDescription, structuredDocs, examplesDirectory);
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                return Resources.exportMD;
            }
        }

        public override Guid ComponentGuid
        {
            get { return new Guid("C6C824E7-8FE8-466A-9118-8A336214B82A"); }
        }
    }
}
